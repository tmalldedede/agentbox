      ...
      <div className="space-y-4 mt-4">
        ...
        {setIsPublic && (
          <div className="flex items-center justify-between p-3 bg-secondary/50 rounded-lg">
            <div>
              <label className="block text-sm font-medium text-foreground/90">Public Profile</label>
              <p className="text-xs text-muted-foreground mt-0.5">
                公开后可在 API Playground 中使用
              </p>
            </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-foreground/90 mb-1">Adapter</label>
            {isNewProfile ? (
              <select
                value={adapter}
          ...
          <div>
            <label className="block text-sm font-medium text-foreground/90 mb-1">Model</label>
            <input
              type="text"
              value={modelName}
        ...
        <div className="pt-4 border-t border-primary">
          <div className="flex items-center justify-between mb-3">
            <label className="block text-sm font-medium text-foreground/90">Quick Select Provider</label>
            <button
          ...
          {selectedProvider && (
            <div className="mt-3 p-3 bg-secondary rounded-lg flex items-center gap-3">
              ...
              <div>
                <div className="font-medium text-foreground">{selectedProvider.name}</div>
