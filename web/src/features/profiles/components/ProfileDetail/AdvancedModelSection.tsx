    ...
    >
      <div className="space-y-4 mt-4">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div>
            <label className="block text-sm font-medium text-foreground/90 mb-1">Haiku Model</label>
            <input
              type="text"
              value={haikuModel}
          ...
          <div>
            <label className="block text-sm font-medium text-foreground/90 mb-1">Sonnet Model</label>
            <input
              type="text"
              value={sonnetModel}
          ...
          <div>
            <label className="block text-sm font-medium text-foreground/90 mb-1">Opus Model</label>
            <input
              type="text"
              value={opusModel}
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-foreground/90 mb-1">API Timeout (ms)</label>
            <input
              type="number"
              value={timeoutMs || ''}
        ...
        <div className="flex items-center gap-3 p-3 bg-secondary rounded-lg">
          ...
          <label htmlFor="disableTraffic" className="flex-1">
            <span className="font-medium text-foreground">Disable Non-essential Traffic</span>
