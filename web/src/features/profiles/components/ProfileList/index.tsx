...
export default function ProfileList() {
  ...
  const handleClick = (profile: Profile) => {
    navigate({ to: `/profiles/${profile.id}` })
  }
    ...
    <div className="min-h-screen">
      ...
      <header className="app-header">
        ...
        <div className="flex items-center gap-2">
          ...
          <button className="btn btn-primary" onClick={() => navigate({ to: '/profiles/new' })}>
      ...
      <div className="p-6">
        ...
        {/* Description */}
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-foreground mb-2">Agent Profiles</h1>
