      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            <span className="font-semibold text-foreground truncate">{webhook.id}</span>
            {!webhook.is_active && (
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-muted-foreground mb-2">
                Secret (Optional)
                <span className="text-muted-foreground ml-2 font-normal">Used for HMAC-SHA256 signature</span>
              </label>
              <input
                type="password"
                value={secret}
            ...
            <div>
              <label className="block text-sm font-medium text-muted-foreground mb-2">Events</label>
      ...
      <div className="p-6">
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center h-64 text-center">
            ...
            <p className="text-muted-foreground mt-2">Create a webhook to receive real-time notifications</p>
          </div>
        ) : (
