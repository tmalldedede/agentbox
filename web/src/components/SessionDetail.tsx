          ...
          <div className="space-y-4">
            ...
            {profile && (
              ...
              >
                ...
                <p className="text-xs text-muted mt-1">{profile.adapter}</p>
              </div>
            )}
            ...
            <div className="card p-4">
              ...
              <p className="text-secondary">{session.agent}</p>
            </div>
            ...
            <div className="card p-4">
              ...
              <p className="text-secondary text-sm font-mono break-all">{session.workspace}</p>
            </div>
            ...
            <div className="card p-4">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-secondary">{session.config.cpu_limit} cores</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-muted flex items-center gap-2">
        ...
        <div className="flex-1 flex flex-col">
          ...
          >
            ...
            <input
              ...
              className="flex-1 bg-transparent border-none outline-none text-primary placeholder:text-muted font-mono"
              autoFocus
            />
            <button
              type="submit"
