    ...
    <div className="card p-4 group transition-colors hover:border-blue-500/50">
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            <span className="font-semibold text-primary truncate">{skill.name}</span>
            <span className="text-xs px-2 py-0.5 rounded bg-secondary text-muted">
              {skill.source_name}
            </span>
            {skill.is_installed && (
  ...
  return (
    <div className="card p-4 group transition-colors hover:border-emerald-500/50">
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            <span className="font-semibold text-primary truncate">{source.name}</span>
            <span className={`text-xs px-2 py-0.5 rounded border ${colors}`}>
              {source.type}
            </span>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-primary border border-border rounded-xl shadow-xl w-full max-w-lg mx-4">
        <div className="flex items-center justify-between p-4 border-b border-border">
          <h2 className="text-lg font-semibold text-primary">添加 Skill 源</h2>
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4">
          ...
          <div>
            ...
            />
            <p className="text-xs text-muted mt-1">粘贴 GitHub 仓库地址自动解析</p>
          </div>
          ...
          <>
            {loadingRemote ? (
              ...
              <div className="flex flex-col items-center justify-center h-64 text-center">
                ...
                <p className="text-secondary text-lg">商店暂无 Skills</p>
                <p className="text-muted mt-2">
                  ...
                  return (
                    <div key={sourceId}>
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <span className="text-sm text-muted">({sourceSkills.length})</span>
                        {fetchingRemote && (
        ...
        {activeTab === 'sources' && (
          <>
            ...
            {loadingSources ? (
              ...
              <div className="flex flex-col items-center justify-center h-64 text-center">
                <Github className="w-16 h-16 text-muted mb-4" />
                <p className="text-secondary text-lg">暂无 Skill 源</p>
                <p className="text-muted mt-2">
