      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            <span className="font-semibold text-primary truncate">{credential.name}</span>
            {credential.is_valid ? (
          ...
          {credential.env_var && (
            <div className="flex items-center gap-2 mt-1">
              <span className="text-xs text-muted">ENV:</span>
            ...
            {providers.map(provider => (
              <div key={provider}>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h2 className="text-lg font-semibold text-primary capitalize">{provider}</h2>
                  <span className="text-sm text-muted">({groupedCredentials[provider].length})</span>
                </div>
