      ...
      <div className="modal max-w-xl" onClick={e => e.stopPropagation()}>
        ...
        <div className="modal-header flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-semibold text-primary">{t('createSession')}</h2>
          ...
          <div className="modal-body space-y-5">
                    ...
                    >
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <p
                            className={`font-medium ${isSelected ? 'text-primary' : 'text-secondary'}`}
                          >
                            {a.display_name}
                          </p>
            ...
            <div>
              ...
              <input
                ...
                className="input"
              />
              <p className="text-xs text-muted mt-1.5">Path to mount in container</p>
            </div>

            {/* API Key */}
            {envKey && (
              <div>
                <label className="block text-sm font-medium text-secondary mb-2">{envKey}</label>
                <input
                  type="password"
                  value={apiKey}
