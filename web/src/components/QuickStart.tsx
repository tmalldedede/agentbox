  ...
  return (
    ...
    >
      <div className="flex items-start justify-between mb-4">
        ...
        <ArrowRight className={`w-5 h-5 text-muted opacity-0 group-hover:opacity-100 group-hover:translate-x-1 transition-all ${colors.text}`} />
      </div>
      <h3 className="text-lg font-bold text-primary mb-1">{agent.display_name}</h3>
      <p className="text-sm text-muted line-clamp-2 mb-4">{agent.description}</p>
          ...
          <div className="mb-10">
            {loading ? (
              ...
              <div className="flex flex-col items-center justify-center py-16 text-center">
                <Cpu className="w-16 h-16 text-muted mb-4" />
