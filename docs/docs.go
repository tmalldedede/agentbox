    ...
    "definitions": {
        ...
        "github_com_tmalldedede_agentbox_internal_profile.ModelConfig": {
            ...
            "properties": {
                ...
                "bearer_token": {
                    "description": "experimental_bearer_token for Codex",
                    "type": "string"
                },
                "disable_traffic": {
                ...
                "env_key": {
                    "description": "Environment variable name for API key (e.g., \"ZHIPU_API_KEY\")",
                    "type": "string"
                },
                "haiku_model": {
                ...
                "provider": {
                    "description": "e.g., \"anthropic\", \"openai\", \"glm\"",
                    "type": "string"
                },
                "reasoning_effort": {
                ...
                "wire_api": {
                    "description": "Codex specific - third-party provider support",
                    "type": "string"
                }
            }
        },
        ...
        "github_com_tmalldedede_agentbox_internal_profile.Profile": {
            ...
            "properties": {
                ...
                "credential_id": {
                    "description": "Credential ID for API authentication",
                    "type": "string"
                },
                "custom_agents": {
        ...
        "github_com_tmalldedede_agentbox_internal_session.ExecEvent": {
            "type": "object",
            "properties": {
                "raw": {
                    "type": "array",
        ...
        "github_com_tmalldedede_agentbox_internal_session.ExecResponse": {
            ...
            "properties": {
                ...
                "events": {
                    "description": "完整事件列表 (当 include_events=true)",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_tmalldedede_agentbox_internal_session.ExecEvent"
                    }
                },
                "execution_id": {
                    "type": "string"
                ...
                "message": {
                    "description": "Agent 最终回复 (新增)",
                    "type": "string"
                },
                "output": {
                    "description": "原始输出 (兼容旧版)",
                    "type": "string"
                },
                "usage": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/github_com_tmalldedede_agentbox_internal_session.TokenUsage"
                        }
                    ]
                }
            }
        ...
        "github_com_tmalldedede_agentbox_internal_session.TokenUsage": {
            "type": "object",
            "properties": {
                "cached_input_tokens": {
                    "type": "integer"
